...
\begin{IEEEkeywords}
Computing science, Sentiment analysis, Music recommendation, Music Emotion Recognition
\end{IEEEkeywords}}
...
After researching these topics, we aim to produce a multimedia system that is able to identify the listener's emotions through text and map them to songs that match this mood. As suggested by Sauro and Lewis [5], the main factor of a success for a system is if it can capture the user as the main actor.  We aim to achieve this by providing an intuitive user interface and also being mindful of the user when constructing our algorithm. During this process, we found novel ways to use emoticons for this purpose. 
...
\begin{figure}[h!]
 \caption{The Valence-Arousal space, labeled by Russell's direct circular projection of adjectives. Source: [4]}
  \centering
